...
{
    public abstract class MyAsyncResult : IAsyncResult
    {
        ...
        protected MyAsyncResult(AsyncCallback callback, object state)
        {
        ...
        protected static TAsyncResult End<TAsyncResult>(IAsyncResult result)
            where TAsyncResult : MyAsyncResult
        {
            if (result == null)
            {
    ...
    public abstract class TypedAsyncResult<T> : MyAsyncResult
    {
        T data;
        ...
        {
            TypedAsyncResult<T> typedResult = MyAsyncResult.End<TypedAsyncResult<T>>(result);
